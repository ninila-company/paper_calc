...
class MainApp(App):
    ...
    def build(self):
        ...
        self.solution1 = TextInput(multiline=False, readonly=False, halign='left', font_size=20,
                                   hint_text='Введите начальный диаметр роля', write_tab=False,)
        self.solution2 = TextInput(multiline=False, readonly=False, halign='left', font_size=20,
                                   hint_text='Введите начальную массу роля', write_tab=False)
        self.solution3 = TextInput(multiline=False, readonly=False, halign='left', font_size=20,
    ...
    def on_button_press(self, instance):
        if instance.text == 'C':
            ...
            if self.solution2.focus:
                self.solution2.text += instance.text
            if self.solution3.focus:
